      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.div
            ...
            className="hidden md:flex items-center gap-2 rounded-full border border-border/60 bg-card px-3 py-1.5 text-xs"
          >
            <span
              className={`h-2 w-2 rounded-full ${
                isLive
                  ? "bg-status-good animate-pulse-glow"
                  : "bg-status-critical"
              }`}
            />
          ...
          <button
            ...
            className="rounded-xl border border-border/60 bg-card px-3 py-2 text-xs font-medium hover:bg-accent transition"
          >
          ...
          <select
            ...
            className="rounded-xl border border-border/60 bg-card px-2 py-2 text-xs font-medium"
          >
          ...
          <Link
            to="/alertes"
            className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-border/60 bg-card hover:bg-accent transition"
          >
